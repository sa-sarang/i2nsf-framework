...
If you follow this link, you will find a "Hackathon-99" folder which 
consists of 8 subfolders. 
...
5. RESTCONF 
   This folder contains the source code for RESTCONF/YANG communication.
6. Scripts
...
7. Security Controller
   ...
   Also, this folder contains stylesheet for Extensible Stylesheet language Transformations (XSLT).
