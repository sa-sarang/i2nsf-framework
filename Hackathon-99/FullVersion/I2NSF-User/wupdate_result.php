...
<form method="post" id = "form" action="wupdate_result2.php"> 
  ...
  <input type="text" name = "Rule_name" id = "Rule name" value = "<?php echo $row1;?>">
  <br><br>
  ...
  <input type="text" name = "Website" id = "Website" value = "<?php echo $row3;?>">
  <br><br>
