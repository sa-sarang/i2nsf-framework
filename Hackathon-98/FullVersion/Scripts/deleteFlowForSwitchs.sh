...
curl -X "DELETE" -H "Content-Type: application/xml" "http://127.0.0.1:8181/restconf/config/opendaylight-inventory:nodes/node/openflow:1/table/0/flow/Test1" -v -u admin:admin
